...
import { ModelsUserCode } from '../gen/api/models/ModelsUserCode';
import { ModelsOptions } from '../gen/api/models/ModelsOptions';
import QRCode from 'easyqrcodejs';
import { OnlinePredictionSharp } from '@mui/icons-material';

export const codeoptions = atom<ModelsOptions>({
  key: 'codeoptions',
  default: {
...
export const sizeselector = selector({
  key: 'sizeselector',
  get: ({ get }) => get(codeoptions).width,
  set: ({ set, get }, size: number) => {
    const o = get(codeoptions);
    set(codeoptions, { ...o, width: size, height: size });
  }
});
